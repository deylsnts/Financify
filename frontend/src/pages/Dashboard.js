    ...
    <Layout>
      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-4 mb-6">
        <div>
          ...
          <p className="text-gray-400 mt-2 text-lg">Your financial overview at a glance</p>
        </div>
          ...
          {["all", "weekly", "monthly", "yearly"].map((f) => (
            <button
              ...
              className={`px-5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 ${
                filter === f ? "bg-indigo-600 text-white shadow-md" : "text-gray-400 hover:bg-slate-700 hover:text-white"
              }`}
            >
